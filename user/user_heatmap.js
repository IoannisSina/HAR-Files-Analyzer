function create_heatmap(data, refresh) {
    if (refresh) document.getElementById("mapid").innerHTML = "";
...
function send_request(refresh) {
    ...
    xml_to_send.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (this.responseText == "") document.getElementById("mapid").innerHTML = "No entries to show";
            else create_heatmap(JSON.parse(this.responseText), refresh);
